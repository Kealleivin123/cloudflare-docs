...
| Offer                                                 | Scenario                                                      |
| ----------------------------------------------------- | ------------------------------------------------------------- |
| [Global CDN Acceleration](#global-cdn-acceleration)   | Higher performance of China Network CDN with dynamic content. |
