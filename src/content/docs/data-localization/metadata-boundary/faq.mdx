...
sidebar:
  order: 3
description: Explore FAQs on Cloudflare's Customer Metadata Boundary, covering data localization, analytics, and usage for Enterprise customers. Learn what's included and excluded.
---
